      ...
      <ul>
        ...
        <li :class="{pass: !!google_key_bound}">
          ...
          <div>
            ...
            <template v-else>
              <a
                v-if="verify_google || !verify_google" @click="resetHandle">{{ $t('google_reset') }}</a>
              <a
                v-if="verify_google"
        ...
        <li class="pass">
          ...
          <div>
            ...
            <em style="color: #999" v-if="google_key_bound && !verify_google">{{ $t('google_login') }}</em>
            <em style="color: #999" v-else-if="!google_key_bound">{{ $t('google_login') }}</em>
            <template v-else>
              <a
