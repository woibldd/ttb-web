  ...
  <div class="invinfo-box">
    <div class="authen_top">
      ...
      <div class="aut_box">
          ...
          <div class="aut_rt">
              <div class="aut_up">
                  <div class="up_face" ref="front" @click="upload('front')"></div>
              </div>
          ...
          <div class="aut_rt">
              <div class="aut_up">
                  <div class="up_emblem" ref="back" @click="upload('back')"></div>
      ...
      <div class="aut_box">
          ...
          <div class="aut_rt">
              <div class="aut_up">
                  <div class="up_take" ref="hold" @click="upload('hold')"></div>
...
<script>
  ...
  const plupload = utils.getExtModule('plupload')
  export default {
    name: 'SafeVerified',
    components: {
      VBtn
    ...
    methods: {
      upload (type) {
        console.log(this.uploadPlugin)
        let result = new this.uploadPlugin.Uploader(this.uplaodConfig)
        result.start()
      },
      submit () {
    ...
    async created () {
      this.uploadPlugin = await plupload
