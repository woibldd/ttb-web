export default {
  ...
  btc_account: "BTC Contract Account",
  unit_account: "Currency Contact Account",
  mix_account: "USDT Contract Account",
  ...
  apikey_help: "TTB.PLUS's API provides a full-featured interface",
  ...
  bind_google_hint_4: "Do not give your key to anyone. TTB.PLUS customer service will never ask you for your key. ",
  ...
  withdraw_hint_min: "Minimum withdrawal quantity: %{amount}%{coin};",
  withdraw_hint_delay: "The transfer of coins to the account depends on the speed of network nodes on the chain (generally, the normal arrival time is within 30 minutes);",
  withdraw_hint_check: "Please carefully check whether the deposit or withdrawal address is correct and consistent. Otherwise, it will result in failure to recharge or unrecoverable assets.",
  withdraw_hint_examine: "In order to ensure the safety of assets on the chain, withdrawal audit needs to be manually determined and reviewed. Please be patient.",
  withdraw_hint_time: "The currency audit time: Beijing time, 9am -- 10pm.",
  ...
  footer_company_info_name: "TTB DIGITAL PRIVATE LIMITED",
  ...
  invite_footer_text: "The final interpretation of this event is owned by TTB.PLUS",
  ...
  invite_attention_content1: "TTB.PLUS will strictly check for duplicate or fake accounts. If there is cheating, you will be disqualified from the event.",
  invite_attention_content2: "The final interpretation of this event is owned by TTB.PLUS and reserves the right to adjust the rules of the rebate activity according to market conditions.",
  next_page: "Next",
  last_page: "Prev",
  ...
  profile_kyc_hint: "Try to verificate your identity through TTB App, it's much easier!",
  ...
  kyc_notice2: "Handheld photo standard:<br />the head is clear<br />Clear documents<br />Contain TTB words + application date<br />Completely display your arm holding the document",
  ...
  active_relay_totally: "Jackpotisworth : ",
  ...
  imta: "TTB Innovative Mining Total Amount",
  ...
  eligibility: "1. Eligibility: Register as a user of the TTB.PLUS platform",
  ...
  ofi: "3. Opening of Innovative Mining: Users can snap need amount of TTB through the page, and the funds spent by users snapping TTB will be frozen.",
  aends: "4.Activity Ends: Innovative Mining will end according to the time expiration, reach the amount limit or the exchange will terminate early according to the market conditions. The final TTB quota will be allocated, depending on the amount of mined coins and the success of all mining users involved in the Innovative  Mining.",
  comptright: "5.Complete the right confirmation to open the currency: After the confirmation is completed, the platform will issue TTB to the user, and part funds which is not successful will be unfrozen.",
  totalamount: "6.Mining Information: The total amount of TTB mining is 1000,000,000 TTB, and each user buys a quota of 10-250000 TTB, 1 TTB ≈ 0.2CNY.",
  actbeloplat: "7.The final interpretation right of this activity belongs to the TTB.PLUS platform.",
  ...
  bq: "TTB provides you with a powerful API that allows you to use quotes, automatic trading, and experience more services.",
  ...
  activity_kyc_banner_title: "TTB reward of <em style=\"color: #CA9048\">\"Registered Relay\"</em> activity is not limited",
  ...
  transaction_fee: "Transaction Fee (valuation TTB)",
  hash_rate_hour: "My Hashrate (TTB/hour)",
  mining_output: "Mining Output(TTB)",
  requirements: "Participation Requirements",
  req_a: "Participate condition: locked position at least 20000IX;",
  req_b: "Standard mining speed: beginning value is %{power} TTB/H. adjustment as the condition of mining, will take affect next integral point;",
  ...
  req_c_c: "After unlock position TTB will release reach 24 hours.",
  req_d: "The least limit of locked position is 20000IX, total amount is 20000IX’s integral multiple.",
  req_e: "The locked position TTB can participation in profit.  ",
  req_f: "The incentives will calculate integral point, the next day according to every hour give out to the user's TTB.PLUS account on a regular basis.",
  req_g: "The final interpretation of these rules shall be vested in TTB.PLUS.",
  more: "more",
  ...
  orders: "Orders",
  my_orders: "My Orders",
  api_tips_one: "1. TTB.PLUS provides you with a strong API, through which you can enjoy services such as Market Query, Automatic Trading, etc. View How To Use via <a target=\"_blank\" href=\"%{link}\">API documentation.</a> ",
  ...
  has_done: "Issue",
  keep_ix_reward_yesterday: "(Yesterday) Trading fees distribution (TTB Holders) :",
  keep_million_ix_reward_yesterday: "%{ix} TTB (1BTC equivalent):",
  ix_second_trading_amount: "TTB released (Secondary market):",
  ix_lock_amount: "TTB (Locked Position) :",
  ix_trading_amout: "Total TTB Circulation (Secondary market):",
  ...
  activity_invite_mine_question_a: "How to register for an TTB.PLUS account?",
  activity_invite_mine_question_a_expand: "After registering an TTB.PLUS account, a ‘personal Center’ will appear →’My Referal’ indicating the three following: “Sign up Referal link\", \"My Referal QR code\", \"My Referal code”, all of which can be used to invite friends to register in the TTB.PLUS platform.",
  ...
  total_invite_reward: "My accumulated rebate amount: %{num}TTB ",
  invite_detail: "Invitation details",
  invite_ix_reward_rules_a: "After registering an TTB.PLUS account, a ‘personal Center’ will appear →’My Referal’ indicating the three following: “Sign up Referal link \", \"My Referal QR code\", \"My Referal code”, all of which can be used to invite friends to register in the TTB.PLUS platform.",
  ...
  activity_explaination_ix: "The final interpretation of this contest activity rests with TTB.PLUS.",
  ...
  activity_piece_buy_text: "Rewards after hold 5000 TTB tokens net purchased",
  ...
  exchnage_mode_switch_prompt: "Whether to open or not <span style=\"color:#F5C109\">%{mode}</span>，Having opened, the transaction rate<br />is calculated according to the current mode。",
  ...
  rate_tips_f: "In this mode, a handling fee will be charged according to the above table for each trading currency, but handling fee for the transaction based on hourly transaction volume and the lock-in volume will be returned to the user with TTB tokens.",
  rate_tips_f_n: "In this mode, the calculation of the level of handling fee is based on the last 30 days of trading volume. If certain conditions are met, rebates will be enjoyed. The handling fee for this mode will not be returned to the user using TTB tokens. ",
  rate_tips_g: "The “TTB/BTC” and “TTB/USDT” pairs are  no longer supported by  the ”Mining Transaction” modules.",
  rate_tips_g_n: "Based on the currency trading against BTC, the price will be converted to BTC value, and settled at 0.00 UTC every day, and on the basis of the prior 30 days of transactions. For example, if the user has traded in the past 30 days on BTC, EOS, ETH, TTB, then the system will convert each of these four currencies into BTC trading volume according to the prevailing price of the BTC (the transaction in the USDT trading area will also be converted), and then calculate the cumulative volume of the prior 30 days at 0.00 UTC every day.",
  ...
  RushBuy_text_list_16: " TTB.PLUS will establish the corresponding USDT and IX independent buying areas. Users can use USDT and IX to participate in the YST buying frenzy area page;",
  ...
  RushBuy_text_list_31: "1. Users in countries and regions such as the United States, China, Singapore, etc., in view of possible changes in the global regulatory environment, please consult your country and regional lawyers before participating in the transaction in order to strictly abide by local laws.  TTB Exchange reserves the right to terminate services to users who may violate the laws of the country and region at any time.。",
  RushBuy_text_list_32: "2..TTB Exchange only provides a free digital currency trading platform, does not make any audit or guarantee of its issue value, and does not assume any liability. If you are not acceptable, please do not participate。",
  ...
  ensurance_rules_a: "TTB using insurance funds to ensure the smooth completion of the process of trading. When the loss of the position is greater than the insured amount, the insurance funds will kick in to cover the loss.。",
  ...
  contract_block_orderaction: "Order",
  ...
  contract_ix_index_price: "TTB Index Price",
  ...
  contract_risk_modal_tips: " TTB employs a sliding incremental risk limit. For BTCUSD contracts, the underlying risk limit is 200 BTC. For each 100 BTC position limit increase, the maintenance margin and initial margin will increase by 0.50%。",
  ...
  contract_how_price_tip_d: " Today at %{next_pay_time}, longs will %{receive} %{feerate}%, and shorts will %{pay} %{feerate}%. TTB.PLUS will not charge fees on funding payments。",
  ...
  guide_title_index0_step1: "Master TTB Perpetual Swap in 3 Simple Steps",
  ...
  guide_title_index1_step0: "Welcome to TTB Perpetual Swap Guide! To give you a better idea of how perpetual swap works, all numbers given are for illustration purposes only.",
  ...
  guide_title_index14_step2: "\"Selling BTC\" here does not represent selling the BTC in your own account. Instead, it means that you borrow 1 BTC from TTB to sell (interest-free).",
  ...
  problem_list6: "6, Thelongs paytheshorts the funding payment When the funding rate is __________,the longs pay the shorts.",
  ...
  contract_content2: "1. When trading in the market,the market trend may not be in your favor.If and when your position margin is insufficient,TTB will in accordance to the contractual terms and conditions and system requirements, liquidate your position and disclose the relevant details.。",
  contract_content3: "2. You must carefully read and comply with the business rules of TTB, understand the mechanics and operating principles of the contract, and the various aspects of risks of the market ",
  ...
  contract_content5: "4 Due to changes in current laws, regulations, policies, rules of contract exchange transactions, the introduction of emergency measures and other reasons, you may not be able to hold an open position or may not be able to continue to hold the position. However, you can still cash out the deposit and profit balance. TTB will provide advanced notification when such situation arises ",
  contract_content6: "There will be areas beyond TTB’s control such as earthquake, floods, fire and other force majeure factors or malfunctioning of computing systems, communication system breakdown leading to trading being interrupted resulting in losses which you will to bear ",
  ...
  ix_indxe_tips: "<a>TTB Index:</a><br/> The  TTB Index tracks the Bitcoin price every 5 seconds. This index  is composite,It is an equally weighted index using the BITSTAMP, GDAX 、KRAKEN and GEMINI BTC/USD prices. The composition is subject to change due to unprecedented instability.",
  ...
  contract_ix_index_source: "TTB Index",
  ...
  contract_close_tips3: "This is the profit and loss forecast after assuming that you have liquidated your position at the market price. It is calculated according to the current orderlist",
  ...
  bubble_ix_team: " TTB Team",
  bubble_site_tips: "Please identify the standard domain name TTB below when you log in：",
  ...
  Contract_Competition_RegistrationMethod1: "In the event page click TTB.PLUS register to complete the competition (need to open an account contract);",
  Contract_Competition_RegistrationMethod2: "opened in the event of time TTB.PLUS user perpetual contract and completed at least one transaction, the system automatically believe the success of the competition, you can enjoy individual competition rules and welfare.",
  Contract_Competition_RegistrationMethod3: "community and race registration form:",
  contract_Competition_RegistrationMethod4: "(1)TTB.PLUS official fill out the form registration:",
  ...
  otc_otutcol_11: "TTB Total Asset Valuation",
  ...
  kyc_cf_id: "ID number",
  kyc_top_authen_1: "Basic information verification LV1",
  kyc_top_authen_2: "Advance verification LV2",
  ...
  bby_shouy23: "2. Log in the official website of TTB.PLUS, click the link, select the coin  you need to lock according to your own situation, click “ Buy” to participate in the project of depositing COINS. Currently, depositing COINS does not support unlocking in advance, and the system will automatically unlock the amount you locked after the end of the lock period and pay the interest.",
  ...
  fund_assets_node_buy_tip: "Are you confirm to purchase and upgrade to TTB global node？",
  ...
  yj_mb: "One-click buy",
  xe_je: "Small amount fast transaction, single dealbelow 50,000",
  wz_xx: "Nosuitable quotefound, or modify condition",
  ...
  gm_sl: "Purchase amount excessmaximum 50,000 limit",
  ...
  link_name: "link name",
  otc_need_authentication: "%{side} requires <span style='color:#F5C109;'>Advanced verification</span>",
  ...
  jg_ck: "Unit pricefor refer only",
  ...
  h5_home_introduce2: "The “100% cold wallet” storage mechanism ensures that the platform assets are fully isolated from the public network, supplemented by multi-layer encryption, multi-level firewall, and multi-signature verification mechanism tothe ultimate protection of user funds.",
  ...
  new_user_register_popup2: "Scan code to add WeChat customer service,join the official community of ix.com to getequivalent of $50 contract transaction bonusinstantly!",
  new_user_register_popup3: "If you have any questions, please contact WeChat directly.",
  pair_table_option_empty: "No added optionalcurrently",
  status: "Status",
  contract_page: {
  ...
  home: {
    ...
    footer: {
      affiliate: "",
      explain: "TTB Exchange is the world's first digital asset trading community. It is committed to realise the ideal utopia nation of blockchain trading ecology and to create an exchange for everyone. I am for everyone, and everyone is for me.  All contributors can share the fruitful outcome from developments of the exchange。",
    ...
    stmodal: {
      ...
      content: "[Innovation Zone] The trading varieties in this zone are all innovative projects, which are blockchain assets with low global liquidity, high price fluctuations and high risks. TTB.PLUS strongly recommends that you go thru in advance and participate in the transaction within the risk scope that you can endure.",
    ...
    gift: { 
      ...
      tips: 'TTB Pro platform presents $188 to new and old customers, please contact customer service to confirm the account and you can receive the bonus.',
  ...
  shareOption: {
    ...
    share_account: "Speed Contract Account",
    account: "Account",
  ...
  contract: {
    ...
    mapTabs: {
      ...
      FUTURE_ETHUSD: `ETHUSD`,
      FUTURE_EOSUSD: `EOSUSD`,
  ...
  otc: {
    ...
    collectionType: 'Payment Method',
    quotation: 'Best Offer',
    paymentDate: 'Arrival time',
    available: 'Available',
    tag1: 'Comprehensive handling fee, recevied time, price, etc., recommended for you',
    tag2: 'New standard for conversion of Fiat to Digital currency. ',
    tag3: 'If you have made payment, please wait patiently for Simplex to release the token',
    tag4: 'Unpaid, continue to make payment',
    tag5: 'Entering Simplex from TTB ',
    tag6: 'If you have completed the payment in Simplex, please wait patiently. Simplex will deposit the digital currency to your TTB account within 5~20 minutes',
    tag7: 'You already know that Simplex is a legal tender and digital currency trading platform independently operated by a third party, and TTB will not be liable for any loss or damage caused by using this service.',
  ...
  h5_home_new: {
    ...
    computer:"Desktop",    
    android:"Android",
    ios1:"IOS Beta Version", 
    ios2:" IOS Enterprise Version",
    describe2:"Why choose TTB?",
    trading:"Transaction",
    describe3:"Fully provide contract, currency, fiat currency, wealth management and other transaction functions to meet the transaction needs of all users",
    safe:"Safety", 
    describe4:"The first 100% cold wallet storage mechanism, isolated from the public network and supplemented with a multi-layered verification mechanism, to ensure the safety of user assets", 
    service:"Service", 
    describe5:"Provide 24-hour uninterrupted dedicated customer service, multi-language support, and achieve second-level response in core service links such as withdrawal", 
  ...
  appNav: {
    ...
    mapNavList: {
      ...
      'hotActive': {
        label: 'Activities',
        children: {
          lock: 'Lock for Dividend',
          invite_reward: 'Referral Program'
        }
      },
      'bidTitle': 'Deposit&Earn',
      'fund_assets_node_buy': 'node purchase',
  ...
  buy_nbzz: {
    ...
    text: [
      ...
      },
      {
        ...
        content: [
          'Register an TTB account.', 'The available balance of the account is at least 100USDT.'
        ]
      },
      {
        title: '3, Please take note',
        content: [
          'If you don’t have an TTB account yet, click here to register to get a $10 contract trading bonus.',
          'Reward Distribution: rewards will be distributed within 48 hours after the event ends. ',
          'TTB reserves the right of final interpretation of the event.'
        ]
      }
    ],
    dialogInfo: {
  ...
  customer: { 
    ...
    useLogin: 'Use <span class="text-primary">TTB mobile App</span> to scan the QR code', 
  },
  fund_contract: {
    activity: {
      create_time:"Create time",
