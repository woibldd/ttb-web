      ...
      if (this.currency === this.symbolInfo.currency) {
        ...
        if (this.side === 1) {
          if (this.$big(this.inputPrice).gt(sell_price_one)) {
            this.flag = true
             this.alertTitle =this.$t('otc_ziurec_3',{currency:this.currency,inputPrice: Number(this.inputPrice).toFixed(2),symbolInfo: Number(sell_price_one).toFixed(2)})
          ...
          if (this.$big(this.inputPrice).lt(buy_price_one)) {
            this.flag = true 
              this.alertTitle =this.$t('otc_ziurec_15',{currency:this.currency,inputPrice: Number(this.inputPrice).toFixed(2),symbolInfo: Number(sell_price_one).toFixed(2)})
