    ...
    <div class="title-box">
      ...
      <div>
        <router-link
          ...
          to="/fund/my/contractMix/index"> {{ $t('account_balance') }}</router-link>
        <router-link
          class="fund-history mr-22"
          to="/fund/my/contractMix/history"> {{ $t('transaction_record') }}</router-link>
        <router-link
          class="fund-history mr-22"
          to="/fund/my/contractMix/assets-history"> {{ $t('capital_record') }}</router-link>
        <router-link
          class="fund-history"
          to="/fund/my/contractMix/winloss-history"> {{ $t('fund.contract.winloss_record') }}</router-link>
      </div>
    </div>
    <div class="clearfix">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div
                ...
                class="balance balance-grey">{{ '≈' + usdtNumber(scope.row.available)+ ' USD' }}</div>
            </template>
          </el-table-column>
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div
                v-if="scope.row.currency!=='METH'"
                class="balance balance-grey">{{ '≈' + usdtNumber(scope.row.available_balance) + ' USD' }}</div>
            </template>
          </el-table-column>
          <el-table-column
            prop="unrealized"
            ...
            <template slot-scope="scope">
              ...
              <div
                v-if="scope.row.currency!=='METH'"
                class="balance balance-grey">{{ '≈' + usdtNumber(scope.row.unrealized) + ' USD' }}</div>
            </template>
          </el-table-column>
          <el-table-column
            prop="margin_user"
            ...
            <template slot-scope="scope">
              ...
              <div
                v-if="scope.row.currency!=='METH'"
                class="balance balance-grey">{{ '≈' + usdtNumber(scope.row.margin_user) + ' USD' }}</div>
            </template>
          </el-table-column>
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div
                v-if="scope.row.currency!=='METH'"
                class="balance balance-grey">{{ '≈' + usdtNumber(scope.row.margin_position) + ' USD' }}</div>
            </template>
          </el-table-column>
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div
                v-if="scope.row.currency!=='METH'"
                class="balance balance-grey">{{ '≈' + usdtNumber(scope.row.margin_delegation) + ' USD' }}</div>
            </template>
          </el-table-column>
          <el-table-column
            prop="currency"
...
export default {
  ...
  computed: {
    computedTitle () {
      const obj = {
        '/fund/my/contractMix': this.$t('account_balance'),
        '/fund/my/contractMix/history': this.$t('transaction_record'),
        '/fund/my/contractMix/assets-history': this.$t('capital_record'),
        '/fund/my/contractMix/index': this.$t('gold_account'),
        '/fund/my/contractMix/winloss-history': this.$t('fund.contract.winloss_record')
      }
