  ...
  <div class="contract-history-container my-fund-content pt-40 f14">
    ...
    <div class="realized-box">
      <div class="realized-item">
        ...
        <div class="value">
          <span :class="realized.realized_total > 0 ? 'bgcolor-unp' : 'bgcolor-dnp'" >{{ realized.realized_total | fixed(8) }}<b>{{ currencyPair.currency }}</b></span>
        </div>
      ...
      <div class="realized-item">
        ...
        <div class="value">
          <span :class="realized.realized_today > 0 ? 'bgcolor-unp' : 'bgcolor-dnp'" >{{ realized.realized_today | fixed(8) }}<b>{{ currencyPair.currency }}</b></span>
        </div>
      ...
      <div class="realized-item">
        ...
        <div class="value">
          <span :class="realized.realized_market > 0 ? 'bgcolor-unp' : 'bgcolor-dnp'" >{{ realized.realized_market | fixed(8) }}<b>{{ currencyPair.currency }}</b></span>
        </div>
      ...
      <div class="realized-item">
        ...
        <div class="value">
          <span :class="realized.realized_price > 0 ? 'bgcolor-unp' : 'bgcolor-dnp'" >{{ realized.realized_price | fixed(8) }}<b>{{ currencyPair.currency }}</b></span>
        </div>
...
export default {
  ...
  methods: {
    async getFundHistory () {
      ...
      let res = await service.getUnitCloseRealized(params)
      if (!!res && !res.code) {
