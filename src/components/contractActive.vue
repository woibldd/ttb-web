<template>
  <div class="contract-active-modal">
    ...
    <div
      ...
      <p class="m_detail">{{ $t('contract.active.contract_content2', {site_name: state.site}) }}</p>
      <p class="m_detail">{{ $t('contract.active.contract_content3', {site_name: state.site}) }}</p>
      <p class="m_detail">{{ $t('contract.active.contract_content4', {site_name: state.site}) }}</p>
      <p class="m_detail">{{ $t('contract.active.contract_content5', {site_name: state.site}) }}</p>
      <p class="m_detail">{{ $t('contract.active.contract_content6', {site_name: state.site}) }}</p>
      <p class="m_detail">{{ $t('contract.active.contract_content7', {site_name: state.site}) }}</p>
      <p class="m_detail">{{ $t('contract.active.contract_content8', {site_name: state.site}) }}</p>
      <el-button
        class="mt-25"
        type="primary"
