...
module.exports = {
  ...
  affix: '',
  companyName: 'IXX.COM',
  exchangeName: 'IXX |  IXX | Rhino Exchange-BTC Contract Exchange Ranking-Bitcoin Price Real-Time Quote Trend Today-Perpetual Delivery Contract, BTC合约交易所排名-比特币价格今日实时行情走势-永续交割合约',
  exchangeNameConfig: {
  ...
  description: 'IXX | Rhino Exchange is the world\'s first digital asset trading community,headquartered in Singapore. It is committed to achieving the ideal state of the blockchain ecosystem of the exchange and building an exchange for everyone. I am for all and everyone is for me. , All contributors participating in the exchange can share the development results of the exchange. IXX是全球首家数字资产交易共同体,总部在新加坡,其致力于实现交易所生态的区块链理想国,打造人人的交易所,我为人人,人人为我,所有参与交易所的贡献者均可共享交易所的发展成果。',
  descriptionConfig: {
    'zh-CN': 'IXX是全球首家数字资产交易共同体,总部在新加坡,其致力于实现交易所生态的区块链理想国,打造人人的交易所,我为人人,人人为我,所有参与交易所的贡献者均可共享交易所的发展成果。',
    'zh-HK': 'IXX交易所是全球首家數位資產交易共同體,總部在新加坡,其致力於實現交易所生態的區塊鏈理想國,打造人人的交易所,我為人人,人人為我,所有參與交易所的貢獻者均可共亯交易所的發展成果。',
