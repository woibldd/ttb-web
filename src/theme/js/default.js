...
module.exports = {
  ...
  exchangeNameConfig: {
    'zh-CN': 'IXX交易所 | 比特币交易所,合约交易所,合约交易所排名,比特币走势,比特币实时行情,永续合约,交割合约,比特币合约,BTC合约,ixx',
    'zh-HK': 'IXX交易所 | 比特幣交易所，合約交易所，合約交易所排名，比特幣走勢，比特幣即時行情，永續合約，交割合約，比特幣合約，BTC合約，ixx',
  ...
  keywords: 'Bitcoin exchange, contract exchange, contract exchange ranking, bitcoin trend, real-time bitcoin market, perpetual contract, delivery contract, bitcoin contract, BTC contract, rhino exchange',
  keywordsConfig: {
