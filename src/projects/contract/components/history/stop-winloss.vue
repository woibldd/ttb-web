    ...
    allowSubmit() {
      ...
      if (this.stopWinState) {
        if (side === 1) {
          ...
          else if (stopWinType === 2 && this.$big(swprice).lt(price) && this.$big(swprice).lt(markPrice)) { 
            return false;
          }
          else if (stopWinType === 3 && this.$big(swprice).lt(price) && this.$big(swprice).lt(indexPrice)) { 
            return false;
          }
        } else {
          ...
          else if (stopWinType === 2 && this.$big(swprice).gt(price) && this.$big(swprice).gt(markPrice)) { 
            return false;
          }
          else if (stopWinType === 3 && this.$big(swprice).gt(price) && this.$big(swprice).gt(indexPrice)) { 
            return false;
          }
        }
      }
