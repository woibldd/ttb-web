export default {
  ...
  "ix_indxe_tips": "<a>IX Index:</a><br/> The  IXBTC Index tracks the Bitcoin price every 5 seconds. This index  is composite,It is an equally weighted index using the BITSTAMP, GDAX 、KRAKEN and GEMINI BTC/USD prices. The composition is subject to change due to unprecedented instability.",
  ...
  "contract_ix_index_source": "IX Index",
