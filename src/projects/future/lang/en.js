export default {
  ...
  "google_reset": "Reset",
  "cash": {
    "th": "Convert Contract Bonus",
    "title": "Contract Trading Bonus",
    "placeholder": "Enter Convert Amount",
    "tip": "Tip: Please complete kyc2 verification",
    "exchange": "Convert Value",
    "cancel": "Confirm Convert",
    "check": "Please check in the contract account, upon successful convert",
    "more": "View more",
    "rule": "Activity Rules",
    "careful": {
      "title": "Notes",
      "t_1": "1. Conversion ratio: 100IX = 0.0004BTC; the daily maximum convert amount for each account is 0.001BTC, and the minimum exchange amount is 0.0004BTC;",
      "t_2": "2. Convertion time: every Tuesday, Wednesday, and Thursday 14: 00-14: 30;",
      "t_3": "3. Convertion users need to complete kyc2 verification",
      "t_4": "4. IX available for deducting funds from convert contract transaction funds account; trading bonus is only applicable to perpetual contract products, cannot be withdrawn and transfers out of contract accounts, and profit can be withdrawn. If users carry out trading bouns transfers, The contract trading bonus will be invalidated and automatically recovered. The exchanged IX Token cannot be returned. "
    }
  },
  "newLoad": {
    ...
    "install":"Install the major version",
  ...
  "new_banner_title": "The world's first Bitcoin equity certification exchange",
  "new_banner_p_1": "Support full-service features anytime, anywhere",
  "new_banner_p_2": "2 million + / second smooth matching experience",
  "new_banner_p_3": "100% cold wallet storage mechanism is more secure",
  "downLoad_1": "iPhone download",
  "downLoad_2": "Android download",
  "broker":{
    "product_1":"High rebate",
    "product_text_1":"Contract + spot double participation",
    "product_text_sub_1":"Two-level rebate up to 50%",
    "product_2":"Data transparency",
    "product_text_2":"Exclusive independent affiliate background",
    "product_text_sub_2":"trading data real-time update",
    "product_3":"Fund security",
    "product_text_3":"Top security company endorsement",
    "product_text_sub_3":"limit security funds security",
    "equity_title":"United & Liberty Alliance Rights",
    "equity_main_txt_1":"Trading Bonus Support",
    "equity_sub_txt_1":"Register to get up to $50 trading bonus",
    "equity_sub_txt_p_1": "0 fee trading easier conversion",
    "equity_main_txt_2":"Private affiliate back-end",
    "equity_sub_txt_2":"Professional affiliate management system",
    "equity_sub_txt_p_2": "free to set daily commission settlement",
    "equity_main_txt_3":"Innovative referral mechanism",
    "equity_sub_txt_3":"Recommended or joined the United & Liberty Alliance",
    "equity_sub_txt_p_3": "you can get an additional referral bonus",
    "equity_main_txt_4":"Marketing support",
    "equity_sub_txt_4":"Customized marketing materials to help ",
    "equity_sub_txt_p_4": "organize various competitions",
    "equity_main_txt_5":"Professional customer service 1V1",
    "equity_sub_txt_5":"One-on-one maintenance of customer service manager",
    "equity_sub_txt_p_5": "timely follow-up and quick resolution of problems",
    "cooperative_title":"Affiliate application",
    "apply_email":"Email application",
    "apply_chat":"Official WeChat",
    "apply_add":"Add a remark Affiliate",
    "slogan":"Strive for a win-win future with every partner who promotes the development of IX.com!"
  },
  "realName": "Real name",
  "join": " Join Now",
  "plan": "Affiliate",
  "login": "Login to IX Affiliate System",
  "next": "Next",
  "bannerText": "IX Exchange is the world's first digital asset trading community. It is committed to realise the ideal utopia nation of blockchain trading ecology and to create an exchange for everyone. I am for everyone, and everyone is for me.  All contributors can share the fruitful outcome from developments of the exchange。",
  "bannerText2": "We will look for partners with common aspirations on a global scale. As long as you have the ability and a willingness to pay for your dreams, you can become an IX global Affiliate with or without crypto currency experience. Let's work together for a win-win situation. Your influence The power is worth the biggest gain!",
  ...
  "equity_2_text": "The industry’s most complete affiliate backend system, up to 80% Commission;",
  ...
  "equity_content": "IX platform will give Affiliate, not only rich benefits but also platform rights and interests",
  "way": "Affiliate Application Method",
  "application_email": "Your email address",
  "application_theme": "Subject",
  "content": "Content",
  "tip_email": "IX Account UID",
  ...
  "application_ipt_email": "Please input the email you used to register on IX",
  "application_check": "Agree",
  "application_xy": "《IX Affiliate Program Service Agreement》",
  "application_email_tip_1": "1.Please use IX trading account for register",
  ...
  "news": "Follow IX social media for more information：",
  "back": "Back",
  "not": "No IX trading account",
  "now": "Register now",
  "s_email": "You have yet to link the email, please link",
  "bd": "Link",
  "agreeList": {
    "title": "Affiliate Program Services Agreement",
    "t_1": "This Affiliate Program Services Agreement (“Services Agreement”) sets forth the terms and conditions of your use of IX Affiliate Program (“Affiliate Program”) and serves to supplement the Terms of Service Agreement (“Agreement”) between you and IX. Please read this Services Agreement completely and carefully before enrolling in IX Affiliate Program. You must agree with and accept all of the terms and conditions contained in this Services Agreement without modifications, which include the terms and conditions expressly set out below and those incorporated herein by reference, before you may become an affiliate under the IX Affiliate Program.",
    "t_2": "PARTIES TO THIS SERVICES AGREEMENT",
    "t_3": "(a) IX Digital Pte Ltd (operating under the trading name ‘IX’), is a P2P (Peer-to-Peer) crypto currency derivatives exchange with any of its designated and permitted successors, hereinafter referred to as the “Company”, “we”, “our”, or “IX”; and ",
    "t_4": "(b) The “Affiliate”, “him/her/it”, “you”, or “your” shall refer to the individual or entity which applies for IX Affiliate Program in accordance with the terms and conditions set forth herein. ",
    ...
    "t_8": "(c) This Services Agreement explains our obligations to you, and explains your obligations to us for the Affiliate Program offered by IX. When you use your account or permit someone else to use it to purchase, or otherwise acquire, access to additional IX service(s) or products or to cancel your IX service(s) (even if we were not notified of such authorization), this Services Agreement covers such ",
    "t_9": "IT IS AGREED:",
    ...
    "t_31": "3.6 The Affiliate is not authorized and shall not in any way impersonate as IX to provide any investment advice on behalf of the Company to the introduced Clients.\n",
    ...
    "t_61": "<a href='https://IXcustomer.zendesk.com/hc/en-us/articles/360034640751--10-1-Announcement-of-Launch-of-Referral-Program-by-IX-com.'>https://IXcustomer.zendesk.com/hc/en-us/articles/360034640751--10-1-Announcement-of-Launch-of-Referral-Program-by-IX-com.</a>",
    ...
    "t_83": "9.1 IX does not guarantee or predict any type of profit or response from said service(s). Under no circumstances shall IX be deemed liable for any direct, indirect, punitive, incidental, consequential, or special damages, losses, expenses, costs, or demands of whatever form and for any reason whatsoever in relation to this Services Agreement, its website, and the services it provides; including any claims, expenses, attorney’s fees, and court costs relating or arising from this Services Agreement. This limitation applies regardless of whether the alleged liability is based on contract, strict liability, tort, warranty, negligence, or any other basis, even if IX has been advised of the possibility of such damages or such damages were reasonably foreseeable. In jurisdictions that do not permit the elimination or limitation of such liabilities, IX’s liability shall be limited to the greatest extent permitted by the law and any unenforceable provisions removed. The Affiliate agrees to hold harmless IX, its employees, agents, shareholders, contractors, and affiliates of such parties from all liabilities, claims, expenses, or any other costs arising, deriving, or related from this Services Agreement, the services, and products they provide. The Affiliate may be asked to provide written assurances.",
    "t_84": "9.2 With respect to IX, as well as its contractors; agents; employees; officers; directors; shareholders; and affiliates of such parties, the Affiliate agrees to defend, release, indemnify, and hold such parties harmless from all liabilities, claims and expenses, including attorney’s fees and court costs, for third party claims relating to or arising under this Services Agreement, the service(s) provided by IX, or his/her/its use of the service(s) provided by IX; including, without limitation, infringement by him/her/it, or by anyone else using such service(s) IX provides to the Affiliate, of any intellectual property or other proprietary rights of any person or entity; or from the violation of any of IX’s operating rules or policies relating to the service(s) provided. When IX may be involved in a suit involving a third party and which is related to  the service(s) provided by Bybit to the Affiliate under this Services Agreement, IX may seek written assurances from the Affiliate in which he/she/it promises to defend, indemnify, and hold Bybit harmless from the costs and liabilities described in this clause. Such written assurances may include, at IX’s sole discretion, the posting of a performance bond(s) or other guarantees reasonably calculated to guarantee payment. The Affiliate’s failure to provide such assurances may be considered by IX to be a breach of this Services Agreement by him/her/it. The terms of this clause will survive any termination or cancellation of this Services Agreement.",
    "t_85": "10. Waiver",
  ...
  "secure_level_2": "High",
  "hide_othersdaw": " Display only %{pair}",
  "Tishi": "  Please enter a username or password ",
  "invite_friends": "Invite friends",
  "invite_kyc2": "KYC Certification",
  "invite_kyc_lv1": "Level 1",
  "invite_kyc_lv2": " Level 2",
  ...
  "withdraw_avlb": "Available Margin",
  ...
  "withdraw_confirmed": "Your withdraw request has been confirmed.",
  "tip_title_quota": "Remaining balance for withdraw",
  ...
  "orderbook_depth_group": "Grouping",
  ...
  "invite_rule_content2": "During the event, each invitee will receive 8% bonus from the fee when completing the transaction",
  ...
  "more_record": "More",
  "first": "First ",
  "bitcoin_equity_certificate": "exchange regards Bitcoin as an equity asset.",
  ...
  "transaction_fee": "Transaction Fee (valuation IX)",
  "hash_rate_hour": "My Hashrate (IX/hour)",
  "mining_output": "Mining Output(IX)",
  "requirements": "Participation Requirements",
  "req_a": "The mining price for miners involved in mining in the “pre-mining” stage is 0.00435USDT;",
  "req_b": "The mining price for miners involved in mining from the time when IX went online to 24:00 on October 23 is 0.00478USDT.",
  "req_c": "The mining price for miners who joined after 00:00 on October 24 (including future new miners) is 0.0058USDT. ",
  "req_d": "Reference price: IX's record lowest closing price is 0.00598USDT.",
  "req_e": "Distribution schedule: the reward will be calculated on an hourly basis and will be distributed to the user’s account every corresponding hour the next day. ",
  "req_f": "This plan will be officially implemented at 0:00 on December 13, 2018.",
  "req_g": "The final interpretation of these rules shall be vested in IX.com.",
  "more": "more",
  ...
  "my_orders": "My Orders",
  "my_order": "My order",
  "api_tips_one": "1. IX.COM provides you with a strong API, through which you can enjoy services such as Market Query, Automatic Trading, etc. View How To Use via <a target=\"_blank\" href=\"%{link}\">API documentation.</a> ",
  ...
  "has_done": "Issue",
  "keep_ix_reward_yesterday": "Holding IX cumulative allocation fee",
  "keep_million_ix_reward_yesterday": "%{ix} IX (1BTC equivalent):",
  "ix_second_trading_amount": "IX released (Secondary market):",
  "ix_lock_amount": "IX (Locked Position) :",
  "ix_trading_amout": "Total IX Circulation (Secondary market):",
  ...
  "activity_invite_mine_question_a": "How to register for an IX.com account?",
  "activity_invite_mine_question_a_expand": "After registering an IX.com account, a ‘personal Center’ will appear →’My Referal’ indicating the three following: “Sign up Referal link\", \"My Referal QR code\", \"My Referal code”, all of which can be used to invite friends to register in the IX.com platform.",
  ...
  "activity_invite_mine_question_c_expand": "Each time a new account holder or invitee generates a transaction, a corresponding proportion of rebate will be generated based on the transaction fee. The rebate is sent to the referrer's trading account in the form of platform token IX, the rebate ratio being 8%. Rebate amount=actual transaction volume generated by the invitee X handling fee ratio X rebate ratio. By inviting people to the platform, the inviter will be rewarded with 8% of the invitee’s trading fees for the first 90 days.From 0:00 on December 13, 2018, incentives of invited mining will continue to be valid (not subjected to the original \"90 days\" validity period, until the platform ceases the \"mining transaction\" mode);",
  "activity_invite_mine_question_d": "How is the rebate calculated?",
  "activity_invite_mine_question_d_expand": "On the basis of this invitation relationship, the inviter may enjoy multiple benefits arising from subsequently launches in the platform.",
  ...
  "total_invite_reward": "My accumulated rebate amount: %{num}IX ",
  "invite_detail": "Invitation details",
  "invite_ix_reward_rules_a": "After registering an IX.com account, a ‘personal Center’ will appear →’My Referal’ indicating the three following: “Sign up Referal link \", \"My Referal QR code\", \"My Referal code”, all of which can be used to invite friends to register in the IX.com platform.",
  ...
  "invite_notice_title": "Invite friends to sign up and the invitee can get <span style=\"color: #FFD426;font-weight: bold;\">8%</span> of the trading fee for <span style=\"color: #FFD426;font-weight: bold;\">90 consecutive days</span>",
  ...
  "activity_explaination_ix": "The final interpretation of this contest activity rests with IX.com.",
  ...
  "header_title_hot_activity": "Activities",
  ...
  "activity_piece_buy_text": "Rewards after hold 5000 IX tokens net purchased",
  ...
  "exchnage_mode_switch_prompt": "Whether to open or not <span style=\"color:#C9A96C\">%{mode}</span>，Having opened, the transaction rate<br />is calculated according to the current mode。",
  ...
  "rate_tips_f": "In this mode, a handling fee will be charged according to the above table for each trading currency, but handling fee for the transaction based on hourly transaction volume and the lock-in volume will be returned to the user with IX tokens.",
  "rate_tips_f_n": "In this mode, the calculation of the level of handling fee is based on the last 30 days of trading volume. If certain conditions are met, rebates will be enjoyed. The handling fee for this mode will not be returned to the user using IX tokens. ",
  "rate_tips_g": "The “IX/BTC” pairs are  no longer supported by  the ”Mining Transaction” modules",
  "rate_tips_g_n": "Based on the currency trading against BTC, the price will be converted to BTC value, and settled at 0.00 UTC every day, and on the basis of the prior 30 days of transactions. For example, if the user has traded in the past 30 days on BTC, EOS, ETH, IX, then the system will convert each of these four currencies into BTC trading volume according to the prevailing price of the BTC (the transaction in the USDT trading area will also be converted), and then calculate the cumulative volume of the prior 30 days at 0.00 UTC every day.",
  "gentle_hint": "Gentle hint",
  "no_alert_again": "No more prompts",
  "footer_company_info_title": "Company",
  "footer_company_info_name": "IX Fintech Pte Ltd",
  "footer_company_info_registion": "Registration Number 201833671D",
  "footer_company_info_address": "Vision Exchange, 2 Venture Drive, #13-03, Singapore, 608526",
  ...
  "download_down_imme": "download now",
  ...
  "moblie_login_banner_million_champ": "<span style=\"color: #C9A96C\">Million USDT </span>Challenge",
  ...
  "rate_tips_i": "Topping up EOS requires a coin address and an EOS address tag. Warning: you will lost your coins If you don’t follow the correct steps to top up EOS!",
  ...
  "ensurance_rules_a": "IX using insurance funds to ensure the smooth completion of the process of trading. When the loss of the position is greater than the insured amount, the insurance funds will kick in to cover the loss.。",
  ...
  "contract_history_postion_header_delta_rate": "Unrealized P&L(%)",
  ...
  "contract_index_resource_tips": "<a>Price sources</a><br/>price data sources。",
  "contract_ix_index_price": "IX Index Price",
  ...
  "contract_action_button_avai_tips": "<a>Available Margin</a><br/>you create an available balance for a commission. Click here to see the wallet details。",
  ...
  "contract_unachieve_calculate": "Daily Realized P&L(%)：",
  ...
  "contract_margin_balance_tips": "<a>Equity</a><br/> Margin Bal = Available bal + Unrealized P&L",
  "contract_avab_tips": "Available Margin = part of the funds that can be used to open new positions and transfer out; does not include the portion of the occupied deposit。",
  "contract_unrealized_profit_and_loss_tips": "Daily Realized P&L = the profit or loss generated by the current user position.。",
  ...
  "contract_mark_price_tips_table": "<a>Mark Price</a><br/> Margin - Margin used by the open and locked positions. If you have enabled a position, this value will decrease as the margin falls, which also means your actual leverage rises. Move the 'slider' to adjust the margin assigned to each position。",
  ...
  "contract_risk_modal_tips": " IX employs a sliding incremental risk limit. For BTCUSD contracts, the underlying risk limit is 200 BTC. For each 100 BTC position limit increase, the maintenance margin and initial margin will increase by 0.50%。",
  ...
  "contract_cost_10_times": "Order Cost",
  ...
  "contract_assign_id": "OrderID",
  "contract_aval_balance": "Available Margin",
  ...
  "contract_how_price_tip_a": "<span style=\"color:#C9A96C\"> %{symbol} </span> </span> is based on <span style=\"color:#C9A96C\"> %{coin} </span>index pricing of %{symbol} contracts.Each contract is worth %{value} of Bitcoin. ",
  "contract_how_price_tip_b": " Funding is paid and received every 8 hours. The next payout event is %{next_pay_time}。",
  "contract_how_price_tip_c": "<span style=\"color:#C9A96C\"> %{symbol} </span> Use the premium index to calculate the fund rate。<span style=\"color:#C9A96C\"> %{id1} </span> and <span style=\"color:#C9A96C\"> %{id2} </span> is the underlying rate，<span style=\"color:#C9A96C\"> %{id3} </span> is the premium rate。They are at <span style=\"color:#C9A96C\"> to calculate the final fund rate </span> being used。",
  "contract_how_price_tip_d": " Today at %{next_pay_time}, longs will %{receive} %{feerate}%, and shorts will %{pay} %{feerate}%. IX.COM will not charge fees on funding payments。",
  ...
  "contract_refer_tu": "More information on fund rates<span style=\"color:#C9A96C\">perpetuals</span> Guide ",
  ...
  "contract_note_ex_a": "<span style=\"color:#C9A96C\">The funding rate </span> is the rate exchanged between users ",
  ...
  "ensurance_btc_future_tutorial": "BTC Series Guide",
  "ensurance_btc_future_rule": "BTCUSD Contracts Rule",
  ...
  "guide_title_index0_step1": "Master IX Perpetual Swap in 3 Simple Steps",
  ...
  "guide_title_index1_step0": "Welcome to IX Perpetual Swap Guide! To give you a better idea of how perpetual swap works, all numbers given are for illustration purposes only.",
  ...
  "guide_title_index14_step2": "\"Selling BTC\" here does not represent selling the BTC in your own account. Instead, it means that you borrow 1 BTC from IX to sell (interest-free).",
  ...
  "contract_content2": "1. When trading in the market,the market trend may not be in your favor.If and when your position margin is insufficient,IX will in accordance to the contractual terms and conditions and system requirements, liquidate your position and disclose the relevant details.。",
  "contract_content3": "2. You must carefully read and comply with the business rules of IX, understand the mechanics and operating principles of the contract, and the various aspects of risks of the market ",
  ...
  "contract_content6": "There will be areas beyond IX’s control such as earthquake, floods, fire and other force majeure factors or malfunctioning of computing systems, communication system breakdown leading to trading being interrupted resulting in losses which you will to bear ",
  ...
  "ix_indxe_tips": "<a>IXX Index:</a><br/> The  IXX BTC Index tracks the Bitcoin price every 5 seconds. This index  is composite,It is an equally weighted index using the BITSTAMP, GDAX 、KRAKEN and GEMINI BTC/USD prices. The composition is subject to change due to unprecedented instability.",
  ...
  "contract_trigger_lose_buy": "Set Sell stop",
  ...
  "contract_competition_tab_3": " Community List ",
  ...
  "contract_competition_tab_34": "Community Name",
  ...
  "contract_history_close_content": "Close order at <span style='color:#C9A96C;'>%{price}</span> ",
  ...
  "error_message1": "Network connection failed. Please try again later。",
  "bubble_ix_team": " IX Team",
  "bubble_site_tips": "Please identify the standard domain name IX below when you log in：",
  ...
  "transfer_btc_history": " BTC transaction history",
  ...
  "persoal_rank": "Tournament personal ranking",
  "profit_rank": "Tournament profit ranking",
  "transaction": "Transaction volume ranking",
  ...
  "otc_buy_tips_c": "Please use the real-time payment method. The delivery will not be reached within 2 hours, the seller has the right to delay the release or cancel the order!",
  ...
  "contract_competition_Jump_2": "Ranking ( Individual participants）",
  ...
  "activity_notice_titla_a": " IX Invitation Activities for Old Customers ",
  "activity_notice_describe_a": "The successful registration of IX.com's old users before 24:00 on March 1, 2019 (UTC+8, the same below). New users are invited to register through exclusive invitation links. Recommenders will receive different proportions of recommended user contract transaction fees for 365 consecutive days. The specific reward proportion depends on the total transaction volume of the recommended users'contracts, as follows：",
  "acitvity_notice_content_a": " Total Transaction Volume of Recommended Persons ",
  "acitvity_notice_content_b": " Recommended rewards ",
  "acitvity_notice_content_c": "0BTC＜ Total Transaction Volume of Recommended Persons ＜1000BTC",
  "acitvity_notice_content_d": "1000BTC≤ Total Transaction Volume of Recommended Persons ＜10000BTC",
  "acitvity_notice_content_e": " Total Transaction Volume of Recommended Persons ≥10000BTC",
  "acitvity_notice_content_f": " Up to 24:00 on March 12, 2019, if the total number of IX positions of the recommender is more than 5 million, no matter how much the recommended person trades, they can directly enjoy 20% recommendation award. ",
  "activity_notice_titla_b": " Recommendee Award ",
  ...
  "Contract_Competition_RegistrationMethod1": "In the event page click IX.com register to complete the competition (need to open an account contract);",
  "Contract_Competition_RegistrationMethod2": "opened in the event of time IX.com user perpetual contract and completed at least one transaction, the system automatically believe the success of the competition, you can enjoy individual competition rules and welfare.",
  "Contract_Competition_RegistrationMethod3": "community and race registration form:",
  "contract_Competition_RegistrationMethod4": "(1)IX.com official fill out the form registration:",
  ...
  "otc_kvcoc_1": "The order details",
  "otc_kvcoc_4": "Drag the file to here, or",
  "otc_kvcoc_5": "Click on the upload",
  "otc_kvcoc_6": "Only JPG/PNG files can be uploaded, and no more than 500kb",
  "otc_kvcoc_7": "View images",
  "otc_kvcoc_8": "Please select payment method",
  "otc_kvcoc_9": "The name cannot be empty",
  "otc_kvcoc_10": "The opening bank cannot be empty",
  "otc_kvcec_11": "The bank card number cannot be empty",
  "otc_kvcec_12": "Alipay account cannot be empty",
  "otc_kvcec_13": "WeChat account cannot be empty",
  "otc_kvcec_14": "The receipt QR code cannot be empty",
  "otc_seiitm_1": "Are you sure you want to delete the payment method？",
  "otc_seiitm_2": "Delete payment method",
  "otc_ziurec_7": "The seller released the coin over time",
  ...
  "fund_assets_node_buy_tip": "are you confirm to purchase and upgrade to IX global node？",
  ...
  "order_apply_message_c": "at %{price} price %{side} %{amount} qty %{currency}USD contract",
  ...
  "contract_play_thr_1": "Individual Glory Ranking",
  "contract_play_thr_2": "Return Rate",
  "contract_play_thr_3": "Lucky Number",
  "contract_play_thr_4": "BTC highest price yesterday",
  "contract_play_thr_5": "Rules",
  "contract_play_thr_6": "The last 2 season of IX.com's Perpetual contract Competition successfully attracted a large number of users to sign up, and many outstanding individual and team traders and emerged. At the request of the majority users, IX.com Exchange will continue to launch Season 3  Trade Competition. Participate with award, willfully rewards with BTC!",
  "contract_play_thr_7": "Promotion Period",
  "contract_play_thr_8": "August 25, 2019 - September 21, 2019",
  "contract_play_thr_9": "Register and redeem of trading bonus for Individual : 1th September - 5th September ",
  "contract_play_thr_10": "Individual Competition Period : 6th September - 21th September",
  "contract_play_thr_11": "Registration Object",
  "contract_play_thr_12": "All registered and activated contract function users can register for individual competition.",
  "contract_play_thr_13": "Entry threshold: contract account balance ≥0.0015BTC.",
  "contract_play_thr_14": "Welfare : To support, when successfully register for the competition, you can contact customer service to get a maximum of $50 equivalent BTC contract trading bonus!",
  "contract_play_thr_15": "Reward Rules",
  "contract_play_thr_16": "Individual Day Award",
  "contract_play_thr_17": "To rank the day according to the operating rate of the individual competitors during the competition. ",
  "contract_play_thr_18": "The first entrant of the day rewarded 0.618 BTC, and the activity progressed for 10 consecutive days, with a total prize pool of 6.18 BTC.",
  "contract_play_thr_19": "Return Rate = Revenue ÷ Turnover (ranking update hourly) ",
  "contract_play_thr_20": "Daily Lucky Draw",
  "contract_play_thr_21": "Sweepstakes: During the competition, users with a volume of ≥1000 (USD) on the day can participate in the Lucky Draw.",
  "contract_play_thr_22": "Rules: After the competition officially start on August 11,  the lottery number is taken from the highest BTC's perpetual contract transaction price “One” digit value. Users whose transaction volume contains this number on that day will share the 0.1BTC reward.",
  "contract_play_thr_23": "Example: Mr. Rice traded a total volume of 12,345 (USD) on a certain day of the competition. Mr. Rice's lottery numbers include [1, 2, 3, 4, 5]. If the BTC's perpetual highest transaction price is 10123.5 USD, the ones place. If the number is 3, then Mr Rice can qualify for the BTC award.",
  "contract_play_thr_24": "Register On-line",
  "contract_play_thr_25": "Precautions",
  "contract_play_thr_26": "1.When awarding prizes, winning users must complete KYC2 verification;",
  "contract_play_thr_27": " IX.com has the final interpretation right.",
  "contract_play_thr_28": "User ID",
  "contract_play_thr_29": "Registered Successful",
  ...
  "contract_play_thr_30": "After the competition, the official customer service staff will contact the winning user, and the reward will be distributed to the platform account of the winning user (subject to complete of advanced verification)",
  "contract_play_thr_31": "In line with diligent and conscientious attitude, IX.com will try its best to ensure the smooth progress of IX Season 3 Trade Competition. If force majeure factors (system failure or communication network conditions, etc.), cause the competition will be in an abnormal state, the organizer has the right to deal with it accordingly, and the trading behavior in the abnormal period is dispose or even disqualified, and will not guarantee the impact of the competition revenue ranking. ",
  "contract_play_thr_32": "Daily activity (personal ranking + lucky draw) prize pool of 0.666 BTC, the competition continue for 15 consecutive days, to the total prize pool about 10BTC 1 Individual Day Award:",
  "contract_play_thr_33": "Individual Day Award:",
  "contract_play_thr_34": "Daily ranking is conducted according to the rate of return of the contestants. In the individual ranking competition, the total prize pool per day is 0.5 BTC and Top5 can be awarded. The specific reward rules are as follows:",
  "contract_play_thr_35": "(Update the latest ranking at 16 o'clock every day),",
  "contract_play_thr_36": "Rate of return calculation: [current snapshot equity - (last snapshot equity + transfer in)] / (last snapshot equity + transfer in)",
  "contract_play_thr_37": "Daily Lucky Draw:",
  "contract_play_thr_38": "Sweepstakes: Users with a daily volume of ≥1000 (USD) can participate in the Lucky Draw.",
  "contract_play_thr_39": "Rules: After the competition officially start on September 6,  the lottery number is taken from the highest BTC's perpetual contract transaction price “One” digit value. Users whose transaction volume contains this number on that day will share the 0.166BTC reward.",
  "contract_play_thr_40": "Example: Mr. Rice traded a total volume of 12,345 (USD) on a certain day of the competition. Mr. Rice's lottery numbers include [1, 2, 3, 4, 5]. If the BTC's perpetual highest transaction price is 10123.5 USD, the ones place. If the number is 3, then Mr Rice can qualify for the BTC award.",
  "otc_quantity": "Qty",
  "fund_contract_up": "Long",
  "fund_contract_down": "Short",
  "fund_contract_open": "Contracts Open",
  "fund_contract_result_yet": "Realized PNL",
  "fund_contract_result_unrealized": "Unrealized P&L",
  ...
  "app_download_tips": "Tips:  APP download  recommended , iOS mobile  version 10.0 or above and Android phone version 7.0 above ",
  ...
  "modal": {
    "safeModal": {
      "greet": "Dear User:",
      "content": "IX.com operates legally in accordance with the laws and regulations of various countries, and regularly discusses the best methods for compliance supervision with regulatory agencies. To promote industry compliance, IX.com will not provide services or part service to the following countries: Cuba, Iran, North Korea, Crimea, China, Sudan, Syria, the United States [including all U.S. territories such as Puerto Rico, American Samoa, Guam, Northern Mariana Islands, US Virgin Islands (St. Croix, St. John and St. Thomas)], Bangladesh, Bolivia, Ecuador and Kyrgyzstan.",
      "salute": "Thank you for your support to IX.com!",
      "confirm": "Accept"
    }
  },
  appNav: {
  ...
  trading: {
    ...
    mapFormContent: {
      ...
      mapTabs: {
        limit: 'Limit',
        market: 'Market',
        stopLoss: 'Take Profit Stop Loss'
      }
    }
  },
  contract: {
