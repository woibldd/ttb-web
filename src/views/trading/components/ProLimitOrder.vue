<template>
  <div class="ix-trade-op limit-order"  :skin="state.skin">
    <div v-if="pairInfo">
      <ul
        class="ul buy-ul"
        v-if="+side===1">
        ...
        <li class="li-worth mb-15">
          ...
          <div class="content">
            <currency-input
              ...
              :scale="pairInfo.price_scale + pairInfo.amount_scale"/>
          </div>
        </li>
        <li class="li-volume mb-15">
