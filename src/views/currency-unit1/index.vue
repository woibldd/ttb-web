                          ...
                          <el-row>
                            ...
                            <el-col :span="6"> 
                              <div @click="setUnitSort('current')">
                                <sort color="#F5C109" :sort="true" :label="$t('market.orderdeal')" :state="stateUnitSortBy('current')"/>
                              </div>
                            </el-col>
                            <el-col :span="8"> 
                              <div @click="setUnitSort('change_24h')" class="txr pr-18">
                                <sort color="#F5C109" :sort="true" :label="$t('market.h24change')" :state="stateUnitSortBy('change_24h')"/>
                              </div> 
                            </el-col>
                          </el-row>
                        </div>
